      ...
      <aside className="shrink-0 bg-white w-[285px] border-r-2 border-[#DEDEDE]/90 pt-[24.5px] px-[32px]">
        ...
        <div className="mt-[28px] min-h-[50%] flex flex-col justify-between">
          <div className="flex flex-col gap-2">
            ...
            <MenuItem
              title="Request"
              icon={pathname === "/dashboard/request" ? RequestActive : Request}
              active={pathname === "/dashboard/request"}
              link="/dashboard/request"
            />
            <MenuItem
              title="History"
              icon={pathname === "/dashboard/history" ? HistoryActive : History}
              active={pathname === "/dashboard/history"}
              link="/dashboard/history"
            />
            <MenuItem
              title="Guide"
              icon={pathname === "/dashboard/guide" ? GuideActive : Guide}
              active={pathname === "/dashboard/guide"}
              link="/dashboard/guide"
            />
            <MenuItem
              title="FAQ"
              icon={pathname === "/dashboard/faq" ? FaqActive : Faq}
