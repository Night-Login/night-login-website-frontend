...
export default function ProjectCard({ image, title, description, tag }: Props) {
  return (
    <div className="max-w-[450px] h-full md:h-auto shrink-0 bg-dark-1 text-neutral-1 rounded-[16px] relative select-none">
      <div className="h-[210px] bg-linear-to-br from-red to-yellow-500 w-full relative rounded-t-[16px] overflow-hidden">
        <Image
          src={image}
          alt="Project Preview"
