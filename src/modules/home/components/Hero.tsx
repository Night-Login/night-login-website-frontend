    ...
    <div className="relative">
      ...
      <main className="min-h-screen flex justify-center items-center overflow-x-hidden relative z-1 px-[2.5%]">
        ...
        >
          ...
          />
          <div className="text-[14px] md:text-[16px] bg-dark-2 font-semibold absolute top-[calc(100%+7px)] left-0 text-neutral-1 px-[34px] py-3 rounded-[25px] rounded-bl-[37px] rounded-tl-none">
