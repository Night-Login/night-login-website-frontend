  ...
  return (
    <main className="relative h-screen">
      ...
      <section className="w-full flex flex-col items-center justify-center pt-28 md:pt-0 relative min-h-screen">
        ...
        <p className="italic text-gray-500 text-sm py-2">
          You must login first before ask project request.
        </p>
        <form
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <input
              className="w-full bg-[#F3F3F3] px-8 py-4 rounded-lg focus:outline-hidden"
              type="email"
